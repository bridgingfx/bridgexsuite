    ...
    <div className="space-y-6 max-w-[1600px] mx-auto">
      ...
      <Tabs defaultValue="profile">
        <div className="grid grid-cols-1 lg:grid-cols-[240px_1fr] gap-6">
          <div className="bg-white dark:bg-dark-card rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-all p-3">
              ...
              <div className="bg-white dark:bg-dark-card rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm hover:shadow-md transition-all p-6">
                ...
                <div className="flex items-center gap-4 flex-wrap mb-6">
                  <Avatar className="w-16 h-16">
                    <AvatarFallback className="bg-brand-50 dark:bg-brand-900/20 text-brand-600 text-lg">AD</AvatarFallback>
                  </Avatar>
                  <div>
