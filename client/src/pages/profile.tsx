...
export default function ProfilePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-sky-500 to-sky-700 rounded-xl p-6 text-white shadow-sm" data-testid="card-profile-header">
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <div className="text-center sm:text-left flex-1 min-w-0">
            ...
            <p className="text-sky-100 text-sm mt-1" data-testid="text-profile-email">{user?.email || ""}</p>
          ...
          {fields.map((field) => (
            <div key={field.label} className="flex items-start gap-3">
              <div className="p-3 bg-sky-50 dark:bg-sky-900/20 rounded-lg shrink-0">
                <field.icon className="w-5 h-5 text-sky-600" />
              </div>
